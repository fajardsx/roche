  ...
  initContent = (id) => {
    ...
    return (
      <div style={{marginBottom:"20px"}}>
        <FindMedicalComponent />
        <div className="journey-patient-support-container padding-0px">
          <div className="journey-patient-support-header padding-horizontal">Free Testing Access</div>
          <div className="journey-patient-support-body padding-horizontal patientbg">
            ...
            <div id="content">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do it sim eiusmod tempor incididunt ut.
              <div
        ...
        <div className="journey-patient-support-container padding-0px">
          <div className="journey-patient-support-header padding-horizontal">Laboratory Contact</div>
